...
#ifndef G_ARM_MSGS__ACTION__DETAIL__GO_TO_POSE__FUNCTIONS_H_
#define G_ARM_MSGS__ACTION__DETAIL__GO_TO_POSE__FUNCTIONS_H_
...
#include "g_arm_msgs/msg/rosidl_generator_c__visibility_control.h"

#include "g_arm_msgs/action/detail/go_to_pose__struct.h"

/// Retrieve pointer to the hash of the description of this type.
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
...
g_arm_msgs__action__GoToPose__get_individual_type_description_source(
  const rosidl_action_type_support_t * type_support);
 ...
 * )) before or use
 * g_arm_msgs__action__GoToPose_Goal__create()
 ...
 * calls
 * g_arm_msgs__action__GoToPose_Goal__init().
...
/**
 * It calls
 * g_arm_msgs__action__GoToPose_Goal__fini()
...
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
const rosidl_runtime_c__type_description__TypeSource *
g_arm_msgs__action__GoToPose_Goal__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
 ...
 * g_arm_msgs__action__GoToPose_Goal__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * g_arm_msgs__action__GoToPose_Goal__Sequence__fini()
 * on the array,
 ...
 * )) before or use
 * g_arm_msgs__action__GoToPose_Result__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * g_arm_msgs__action__GoToPose_Result__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
...
/**
 * It calls
 * g_arm_msgs__action__GoToPose_Result__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
...
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
const rosidl_runtime_c__type_description__TypeSource *
g_arm_msgs__action__GoToPose_Result__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
...
/**
 * It allocates the memory for the array and calls
 * g_arm_msgs__action__GoToPose_Result__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
...
/**
 * It calls
 * g_arm_msgs__action__GoToPose_Result__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * g_arm_msgs__action__GoToPose_Feedback__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * g_arm_msgs__action__GoToPose_Feedback__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
...
/**
 * It calls
 * g_arm_msgs__action__GoToPose_Feedback__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
...
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
const rosidl_runtime_c__type_description__TypeSource *
g_arm_msgs__action__GoToPose_Feedback__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
...
/**
 * It allocates the memory for the array and calls
 * g_arm_msgs__action__GoToPose_Feedback__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
...
/**
 * It calls
 * g_arm_msgs__action__GoToPose_Feedback__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
const rosidl_runtime_c__type_description__TypeSource *
g_arm_msgs__action__GoToPose_SendGoal__get_individual_type_description_source(
  const rosidl_service_type_support_t * type_support);
 ...
 * )) before or use
 * g_arm_msgs__action__GoToPose_SendGoal_Request__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * g_arm_msgs__action__GoToPose_SendGoal_Request__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
...
/**
 * It calls
 * g_arm_msgs__action__GoToPose_SendGoal_Request__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
...
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
const rosidl_runtime_c__type_description__TypeSource *
g_arm_msgs__action__GoToPose_SendGoal_Request__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
...
/**
 * It calls
 * g_arm_msgs__action__GoToPose_SendGoal_Request__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * g_arm_msgs__action__GoToPose_SendGoal_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * g_arm_msgs__action__GoToPose_SendGoal_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
...
/**
 * It calls
 * g_arm_msgs__action__GoToPose_SendGoal_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
...
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
const rosidl_runtime_c__type_description__TypeSource *
g_arm_msgs__action__GoToPose_SendGoal_Response__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
...
/**
 * It calls
 * g_arm_msgs__action__GoToPose_SendGoal_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * g_arm_msgs__action__GoToPose_SendGoal_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * g_arm_msgs__action__GoToPose_SendGoal_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
...
/**
 * It calls
 * g_arm_msgs__action__GoToPose_SendGoal_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
...
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
const rosidl_runtime_c__type_description__TypeSource *
g_arm_msgs__action__GoToPose_SendGoal_Event__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
...
/**
 * It allocates the memory for the array and calls
 * g_arm_msgs__action__GoToPose_SendGoal_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
...
/**
 * It calls
 * g_arm_msgs__action__GoToPose_SendGoal_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
const rosidl_runtime_c__type_description__TypeSource *
g_arm_msgs__action__GoToPose_GetResult__get_individual_type_description_source(
  const rosidl_service_type_support_t * type_support);
 ...
 * )) before or use
 * g_arm_msgs__action__GoToPose_GetResult_Request__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * g_arm_msgs__action__GoToPose_GetResult_Request__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
...
/**
 * It calls
 * g_arm_msgs__action__GoToPose_GetResult_Request__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
...
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
const rosidl_runtime_c__type_description__TypeSource *
g_arm_msgs__action__GoToPose_GetResult_Request__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
...
/**
 * It calls
 * g_arm_msgs__action__GoToPose_GetResult_Request__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * g_arm_msgs__action__GoToPose_GetResult_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * g_arm_msgs__action__GoToPose_GetResult_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
...
/**
 * It calls
 * g_arm_msgs__action__GoToPose_GetResult_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
...
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
const rosidl_runtime_c__type_description__TypeSource *
g_arm_msgs__action__GoToPose_GetResult_Response__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
...
/**
 * It calls
 * g_arm_msgs__action__GoToPose_GetResult_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * g_arm_msgs__action__GoToPose_GetResult_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * g_arm_msgs__action__GoToPose_GetResult_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
...
/**
 * It calls
 * g_arm_msgs__action__GoToPose_GetResult_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
...
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
const rosidl_runtime_c__type_description__TypeSource *
g_arm_msgs__action__GoToPose_GetResult_Event__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
...
/**
 * It allocates the memory for the array and calls
 * g_arm_msgs__action__GoToPose_GetResult_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
...
/**
 * It calls
 * g_arm_msgs__action__GoToPose_GetResult_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * g_arm_msgs__action__GoToPose_FeedbackMessage__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * g_arm_msgs__action__GoToPose_FeedbackMessage__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
...
/**
 * It calls
 * g_arm_msgs__action__GoToPose_FeedbackMessage__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
...
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
const rosidl_runtime_c__type_description__TypeSource *
g_arm_msgs__action__GoToPose_FeedbackMessage__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
...
/**
 * It allocates the memory for the array and calls
 * g_arm_msgs__action__GoToPose_FeedbackMessage__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_g_arm_msgs
...
/**
 * It calls
 * g_arm_msgs__action__GoToPose_FeedbackMessage__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // G_ARM_MSGS__ACTION__DETAIL__GO_TO_POSE__FUNCTIONS_H_
