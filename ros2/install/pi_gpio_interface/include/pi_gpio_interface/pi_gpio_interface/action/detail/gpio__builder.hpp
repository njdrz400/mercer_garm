...
class Init_GPIO_SendGoal_Event_response
{
public:
  explicit Init_GPIO_SendGoal_Event_response(::pi_gpio_interface::action::GPIO_SendGoal_Event & msg)
  : msg_(msg)
  {}
  ::pi_gpio_interface::action::GPIO_SendGoal_Event response(::pi_gpio_interface::action::GPIO_SendGoal_Event::_response_type arg)
  {
...
private:
  ::pi_gpio_interface::action::GPIO_SendGoal_Event msg_;
};

class Init_GPIO_SendGoal_Event_request
{
public:
  explicit Init_GPIO_SendGoal_Event_request(::pi_gpio_interface::action::GPIO_SendGoal_Event & msg)
  : msg_(msg)
  {}
  Init_GPIO_SendGoal_Event_response request(::pi_gpio_interface::action::GPIO_SendGoal_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_GPIO_SendGoal_Event_response(msg_);
  }
...
class Init_GPIO_SendGoal_Event_info
{
public:
  Init_GPIO_SendGoal_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_GPIO_SendGoal_Event_request info(::pi_gpio_interface::action::GPIO_SendGoal_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_GPIO_SendGoal_Event_request(msg_);
  }
...
template<>
inline
auto build<::pi_gpio_interface::action::GPIO_SendGoal_Event>()
{
  return pi_gpio_interface::action::builder::Init_GPIO_SendGoal_Event_info();
}
...
class Init_GPIO_GetResult_Event_response
{
public:
  explicit Init_GPIO_GetResult_Event_response(::pi_gpio_interface::action::GPIO_GetResult_Event & msg)
  : msg_(msg)
  {}
  ::pi_gpio_interface::action::GPIO_GetResult_Event response(::pi_gpio_interface::action::GPIO_GetResult_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::pi_gpio_interface::action::GPIO_GetResult_Event msg_;
};

class Init_GPIO_GetResult_Event_request
{
public:
  explicit Init_GPIO_GetResult_Event_request(::pi_gpio_interface::action::GPIO_GetResult_Event & msg)
  : msg_(msg)
  {}
  Init_GPIO_GetResult_Event_response request(::pi_gpio_interface::action::GPIO_GetResult_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_GPIO_GetResult_Event_response(msg_);
  }
...
class Init_GPIO_GetResult_Event_info
{
public:
  Init_GPIO_GetResult_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_GPIO_GetResult_Event_request info(::pi_gpio_interface::action::GPIO_GetResult_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_GPIO_GetResult_Event_request(msg_);
  }
...
template<>
inline
auto build<::pi_gpio_interface::action::GPIO_GetResult_Event>()
{
  return pi_gpio_interface::action::builder::Init_GPIO_GetResult_Event_info();
}
