...
enum
{
  pi_gpio_interface__action__GPIO_SendGoal_Event__request__MAX_SIZE = 1
};
// response
enum
{
  pi_gpio_interface__action__GPIO_SendGoal_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/GPIO in the package pi_gpio_interface.
typedef struct pi_gpio_interface__action__GPIO_SendGoal_Event
{
  service_msgs__msg__ServiceEventInfo info;
  pi_gpio_interface__action__GPIO_SendGoal_Request__Sequence request;
  pi_gpio_interface__action__GPIO_SendGoal_Response__Sequence response;
} pi_gpio_interface__action__GPIO_SendGoal_Event;

// Struct for a sequence of pi_gpio_interface__action__GPIO_SendGoal_Event.
typedef struct pi_gpio_interface__action__GPIO_SendGoal_Event__Sequence
{
...
enum
{
  pi_gpio_interface__action__GPIO_GetResult_Event__request__MAX_SIZE = 1
};
// response
enum
{
  pi_gpio_interface__action__GPIO_GetResult_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/GPIO in the package pi_gpio_interface.
typedef struct pi_gpio_interface__action__GPIO_GetResult_Event
{
  service_msgs__msg__ServiceEventInfo info;
  pi_gpio_interface__action__GPIO_GetResult_Request__Sequence request;
  pi_gpio_interface__action__GPIO_GetResult_Response__Sequence response;
} pi_gpio_interface__action__GPIO_GetResult_Event;

// Struct for a sequence of pi_gpio_interface__action__GPIO_GetResult_Event.
typedef struct pi_gpio_interface__action__GPIO_GetResult_Event__Sequence
{
