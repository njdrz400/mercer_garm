...
inline std::string to_yaml(const GPIO_Goal & msg, bool use_flow_style = false)
{
...
[[deprecated("use pi_gpio_interface::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const pi_gpio_interface::action::GPIO_Goal & msg,
  std::ostream & out, size_t indentation = 0)
{
  pi_gpio_interface::action::to_block_style_yaml(msg, out, indentation);
}

[[deprecated("use pi_gpio_interface::action::to_yaml() instead")]]
inline std::string to_yaml(const pi_gpio_interface::action::GPIO_Goal & msg)
{
  return pi_gpio_interface::action::to_yaml(msg);
}
...
inline std::string to_yaml(const GPIO_Result & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use pi_gpio_interface::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const pi_gpio_interface::action::GPIO_Result & msg,
  std::ostream & out, size_t indentation = 0)
{
  pi_gpio_interface::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use pi_gpio_interface::action::to_yaml() instead")]]
inline std::string to_yaml(const pi_gpio_interface::action::GPIO_Result & msg)
{
  return pi_gpio_interface::action::to_yaml(msg);
}
...
inline std::string to_yaml(const GPIO_Feedback & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use pi_gpio_interface::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const pi_gpio_interface::action::GPIO_Feedback & msg,
  std::ostream & out, size_t indentation = 0)
{
  pi_gpio_interface::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use pi_gpio_interface::action::to_yaml() instead")]]
inline std::string to_yaml(const pi_gpio_interface::action::GPIO_Feedback & msg)
{
  return pi_gpio_interface::action::to_yaml(msg);
}
...
inline void to_flow_style_yaml(
  const GPIO_SendGoal_Request & msg,
  std::ostream & out)
{
  out << "{";
  // member: goal_id
...
inline std::string to_yaml(const GPIO_SendGoal_Request & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use pi_gpio_interface::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const pi_gpio_interface::action::GPIO_SendGoal_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
  pi_gpio_interface::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use pi_gpio_interface::action::to_yaml() instead")]]
inline std::string to_yaml(const pi_gpio_interface::action::GPIO_SendGoal_Request & msg)
{
  return pi_gpio_interface::action::to_yaml(msg);
}
...
inline void to_flow_style_yaml(
  const GPIO_SendGoal_Response & msg,
  std::ostream & out)
{
  out << "{";
  // member: accepted
...
inline std::string to_yaml(const GPIO_SendGoal_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use pi_gpio_interface::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const pi_gpio_interface::action::GPIO_SendGoal_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  pi_gpio_interface::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use pi_gpio_interface::action::to_yaml() instead")]]
inline std::string to_yaml(const pi_gpio_interface::action::GPIO_SendGoal_Response & msg)
{
  return pi_gpio_interface::action::to_yaml(msg);
}
...
inline std::string to_yaml(const GPIO_SendGoal_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use pi_gpio_interface::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const pi_gpio_interface::action::GPIO_SendGoal_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  pi_gpio_interface::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use pi_gpio_interface::action::to_yaml() instead")]]
inline std::string to_yaml(const pi_gpio_interface::action::GPIO_SendGoal_Event & msg)
{
  return pi_gpio_interface::action::to_yaml(msg);
}

template<>
inline const char * data_type<pi_gpio_interface::action::GPIO_SendGoal_Event>()
{
  return "pi_gpio_interface::action::GPIO_SendGoal_Event";
}

template<>
inline const char * name<pi_gpio_interface::action::GPIO_SendGoal_Event>()
{
  return "pi_gpio_interface/action/GPIO_SendGoal_Event";
}

template<>
struct has_fixed_size<pi_gpio_interface::action::GPIO_SendGoal_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<pi_gpio_interface::action::GPIO_SendGoal_Event>
  : std::integral_constant<bool, has_bounded_size<pi_gpio_interface::action::GPIO_SendGoal_Request>::value && has_bounded_size<pi_gpio_interface::action::GPIO_SendGoal_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<pi_gpio_interface::action::GPIO_SendGoal_Event>
  : std::true_type {};
...
inline void to_flow_style_yaml(
  const GPIO_GetResult_Request & msg,
  std::ostream & out)
{
  out << "{";
  // member: goal_id
...
inline std::string to_yaml(const GPIO_GetResult_Request & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use pi_gpio_interface::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const pi_gpio_interface::action::GPIO_GetResult_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
  pi_gpio_interface::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use pi_gpio_interface::action::to_yaml() instead")]]
inline std::string to_yaml(const pi_gpio_interface::action::GPIO_GetResult_Request & msg)
{
  return pi_gpio_interface::action::to_yaml(msg);
}
...
inline void to_flow_style_yaml(
  const GPIO_GetResult_Response & msg,
  std::ostream & out)
{
  out << "{";
  // member: status
...
inline std::string to_yaml(const GPIO_GetResult_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use pi_gpio_interface::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const pi_gpio_interface::action::GPIO_GetResult_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  pi_gpio_interface::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use pi_gpio_interface::action::to_yaml() instead")]]
inline std::string to_yaml(const pi_gpio_interface::action::GPIO_GetResult_Response & msg)
{
  return pi_gpio_interface::action::to_yaml(msg);
}
...
inline void to_flow_style_yaml(
  const GPIO_GetResult_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const GPIO_GetResult_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use pi_gpio_interface::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const pi_gpio_interface::action::GPIO_GetResult_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  pi_gpio_interface::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use pi_gpio_interface::action::to_yaml() instead")]]
inline std::string to_yaml(const pi_gpio_interface::action::GPIO_GetResult_Event & msg)
{
  return pi_gpio_interface::action::to_yaml(msg);
}

template<>
inline const char * data_type<pi_gpio_interface::action::GPIO_GetResult_Event>()
{
  return "pi_gpio_interface::action::GPIO_GetResult_Event";
}

template<>
inline const char * name<pi_gpio_interface::action::GPIO_GetResult_Event>()
{
  return "pi_gpio_interface/action/GPIO_GetResult_Event";
}

template<>
struct has_fixed_size<pi_gpio_interface::action::GPIO_GetResult_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<pi_gpio_interface::action::GPIO_GetResult_Event>
  : std::integral_constant<bool, has_bounded_size<pi_gpio_interface::action::GPIO_GetResult_Request>::value && has_bounded_size<pi_gpio_interface::action::GPIO_GetResult_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<pi_gpio_interface::action::GPIO_GetResult_Event>
  : std::true_type {};
...
inline void to_flow_style_yaml(
  const GPIO_FeedbackMessage & msg,
  std::ostream & out)
{
  out << "{";
  // member: goal_id
...
inline std::string to_yaml(const GPIO_FeedbackMessage & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use pi_gpio_interface::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const pi_gpio_interface::action::GPIO_FeedbackMessage & msg,
  std::ostream & out, size_t indentation = 0)
{
  pi_gpio_interface::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use pi_gpio_interface::action::to_yaml() instead")]]
inline std::string to_yaml(const pi_gpio_interface::action::GPIO_FeedbackMessage & msg)
{
  return pi_gpio_interface::action::to_yaml(msg);
}
